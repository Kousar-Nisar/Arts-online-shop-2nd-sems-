...
<head>
    ...
    <title>{{ config('app.name', 'Arts-online-shop') }}</title>
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            <img class="" id="logo_header_1" alt="" src="{{ asset('assets/images/Shopping Logo.png') }}"
                                data-light="{{ asset('assets/images/Shopping Logo.png') }}" data-dark="{{ asset('assets/images/Shopping Logo.png') }}">
                        </a>
                    ...
                    <div class="center">
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    <a href="{{route('admin.active_users')}}" class="">
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Aptech MSG</div>
                        </div>
                    </div>
