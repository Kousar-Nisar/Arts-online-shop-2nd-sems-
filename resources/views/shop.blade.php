            ...
            <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
              ...
              <div class="accordion-body px-0 pb-0 pt-3">
                <ul class="list list-inline mb-0">
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Gift articles</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Greeting cards</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Dolls</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Files</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Hand bags</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Wallets</a>
                  </li>
                  <li class="list-item">
                    <a href="#" class="menu-link py-1">Beauty products</a>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Bueaty <br /><strong>PRODUCTS</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Beauty products are the best way to
                      update your look. Add a title edge with new styles and new colors, or go for timeless pieces.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="{{ asset('assets/images/cosmetic-bottle-on-geometric-podium-mock-up-banner-vector-29534018.jpg') }}" width="630" height="450"
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Women's <br /><strong>HANDBAGS</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Handbags are the best way to
                      update your look. Add a title edge with new styles and new colors, or go for timeless pieces.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="{{ asset('assets/images/e0977b22-ae7d-4e60-8b6e-1e581967bab0.jpg')}}" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      Greeting <br /><strong>Cards</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Greeting cards are the best way to
                      update your look. Add a title edge with new styles and new colors, or go for timeless pieces.</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="{{ asset('assets/images/pngtree-modern-happy-birthday-greeting-card-image_1858382.jpg')}}" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
